...
public enum CustomErrorCode {
    ...
    INVALID_PASSWORD_FORMAT(HttpStatus.BAD_REQUEST, "비밀번호는 8자 이상이며 영어, 숫자, 특수문자를 각각 1개 이상 포함해야 합니다."),
    ...
    INVALID_COMMENT_LENGTH(HttpStatus.BAD_REQUEST, "소개글은 40자 이하여야 합니다."),
    SAME_COMMENT(HttpStatus.BAD_REQUEST, "변경하려는 소개글이 현재 소개글과 동일합니다."),
